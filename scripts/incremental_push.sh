...
flush(){
  ...
  git add sketch_variations/disp_2026-06-01-D sketch_variations/disp_2026-06-01-E \
          docs/selection/index.html >>"$LOG" 2>&1 || true
  if ! git diff --cached --quiet 2>/dev/null; then
    local n=$(find sketch_variations/disp_2026-06-01-D sketch_variations/disp_2026-06-01-E \
